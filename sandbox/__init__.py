...
from .api.arts import Alabels, Arts, CArts, Lenta, LLenta
...
from .arts.views import (
    show_art, show_arts, show_author, show_carts, show_followed,
    show_labeled_arts, show_labeled_author, show_labeled_f)
